Wernick := module () 
export 
	norm2, powLine, onLine, prodScalV, prodVectV, dotProd, onb, onmed, midp1, midp2, ibar1, ibar2, filterLsLc, mpr, 
	A, B, C, Ma, Mb, Mc, Oo, Gg, Ha, Hb, Hc, Hh, Ta, Tb, Tc, Ii, Ea, Eb, Ec, Nn, xA, yA, xB, yB, xC, yC, Rw,
	Hw, Wtf, Wt, defFig, drawFig, num, Lvar; 
	
# 
#
#
local 
	onbaux, onbaux_pm, testnull, testSc, testSl, 
	A1, A2, B1, B2, C1, C2, Ma1, Ma2, Mb1, Mb2, Mc1, Mc2, O1, O2, G1, G2, 
	Ha1, Ha2, Hb1, Hb2, Hc1, Hc2, H1, H2, N1, N2, Ta1, Ta2, Tb1, Tb2, Tc1, Tc2, 
	I1, I2; 
...
# cross product 
prodVectV := proc (xU, yU, xV, yV)  return xU*yV-yU*xV end proc; 
...
onbaux_pm:= proc (x, y, xS, yS, xM, yM, xN, yN) 
	return prodVectV(xM-xS, yM-yS, x-xS, y-yS)*prodScalV(xN-xS,yN-yS, x-xS, y-yS) -
	prodVectV(x-xS, y-yS, xN-xS, yN-yS)*prodScalV(xM-xS,yM-yS, x-xS, y-yS)
	end proc;
...
O2 := proc (xO, yO)  return onmed(xO, yO, xB, yB, xC, yC) end proc; 
